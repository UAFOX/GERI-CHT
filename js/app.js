...
(() => {
  ...
  (() => {
    ...
    window.addEventListener("load", function (e) {
      ...
      const s = document.querySelector("[data-calendar]");
      if (s) {
        hs(s, {
          customMonths: [
            "Январь",
    ...
    const ps = document.querySelectorAll("[dat-drop]"),
      gs = document.querySelectorAll(".comment-detail-card");
    function ms(e, t) {
      e.forEach(function (e) {
        e.classList.remove(t);
      });
    ...
    document.addEventListener("click", function (e) {
      ...
      t.closest("[dat-drop]")
        ...
        : ms(ps, "active"),
        t.closest(".comment-detail-card")
          ? (t
              .closest(".comment-detail-card")
              .classList.toggle("active-comment"),
            e.preventDefault)
          : ms(gs, "active-comment");
    });
    const fs = document.querySelectorAll(".column-our-chefs__picture-ibg");
    var vs;
    fs.length
      ? fs.forEach((e) => {
      ...
      (vs = !1),
      (m.selectModule = new p({ logging: vs })),
      (function (e = !1) {
        new ds({ logging: e });
      })(!1),
      (function () {
