(() => {
  ...
  function re({ swiper: e, extendParams: t, on: s, emit: i }) {
    ...
    function p() {
      ...
      if ("bullets" === t.type) {
        ...
        n.html(r), (e.pagination.bullets = n.find(ne(t.bulletClass)));
      }
      "fraction" === t.type &&
        ((r = t.renderFraction
    ...
    function l() {
      ...
      if (
        ...
        t.children(`.${s.slideVisibleClass}`).each((e) => {
          a(l ? b(e).attr("data-swiper-slide-index") : b(e).index());
        });
  ...
  const pe = document.querySelector("header"),
    ue = document.querySelector(".menu__body");
  new MutationObserver((e) => {
    for (const t of e)
      if (t.target === pe) {
        t.addedNodes[0].querySelector("._header-show") &&
          ue.classList.add("active");
      }
  }).observe(pe, { childList: !0 }),
    (function (e) {
      let t = new Image();
      (t.onload = t.onerror =
        function () {
      ...
      function e(e) {
        if ("click" === e.type) {
          ...
          if (t.closest("[data-goto]")) {
            ...
            r(`#${s.dataset.goto}`, i, n), e.preventDefault();
          }
